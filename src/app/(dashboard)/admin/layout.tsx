    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-40" onClick={() => setMobileMenuOpen(false)}>
          ...
          <div className="absolute left-0 top-0 bottom-0 w-[280px] bg-card border-r border-border shadow-2xl transform transition-transform duration-300 ease-out flex flex-col" onClick={(e) => e.stopPropagation()}>
