    ...
    return (
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="bg-card/50 backdrop-blur-xl border border-border shadow-2xl rounded-3xl p-4 space-y-3">
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-4 gap-4 sm:gap-6">
        <div className="bg-card/50 backdrop-blur-xl border border-border p-5 rounded-3xl shadow-2xl hover:border-primary/50 transition-all group">
          <div className="w-12 h-12 rounded-2xl bg-primary/10 flex items-center justify-center mb-4 border border-primary/20 group-hover:shadow-[0_0_15px_rgb(245_158_11_/_0.3)] transition-all">
        ...
        <div className="bg-card/50 backdrop-blur-xl border border-border p-5 rounded-3xl shadow-2xl hover:border-destructive/50 transition-all group">
          <div className="w-12 h-12 rounded-2xl bg-destructive/10 flex items-center justify-center mb-4 border border-destructive/20 group-hover:shadow-[0_0_15px_rgb(239_68_68_/_0.3)] transition-all">
        ...
        <div className="bg-card/50 backdrop-blur-xl border border-border p-5 rounded-3xl shadow-2xl hover:border-info/50 transition-all group">
          <div className="w-12 h-12 rounded-2xl bg-info/10 flex items-center justify-center mb-4 border border-info/20 group-hover:shadow-[0_0_15px_rgb(59_130_246_/_0.3)] transition-all">
        ...
        <div className="bg-card/50 backdrop-blur-xl border border-border p-5 rounded-3xl shadow-2xl hover:border-success/50 transition-all group">
          <div className="w-12 h-12 rounded-2xl bg-success/10 flex items-center justify-center mb-4 border border-success/20 group-hover:shadow-[0_0_15px_rgb(16_185_129_/_0.3)] transition-all">
      ...
      <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-card/50 backdrop-blur-xl border border-border rounded-3xl p-6 shadow-2xl">
          <div className="flex items-center justify-between mb-6">
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-card/50 backdrop-blur-xl border border-border rounded-3xl p-6 shadow-2xl">
          ...
          <div className="space-y-4">
            <Link href="/admin/events/new" className="block p-4 bg-primary/10 text-primary border border-primary/20 rounded-2xl hover:bg-primary/20 transition-all cursor-pointer font-medium shadow-[inset_0_0_15px_rgb(245_158_11_/_0.05)]">
              <span className="text-xl mr-2">+</span> Buat Event Baru
            </Link>
            <Link href="/admin/galleries/new" className="block p-4 bg-info/10 text-info border border-info/20 rounded-2xl hover:bg-info/20 transition-all cursor-pointer font-medium shadow-[inset_0_0_15px_rgb(59_130_246_/_0.05)]">
              <span className="text-xl mr-2">+</span> Buat Gallery Baru
            </Link>
            <a href="/booking" className="block p-4 bg-success/10 text-success border border-success/20 rounded-2xl hover:bg-success/20 transition-all cursor-pointer font-medium shadow-[inset_0_0_15px_rgb(16_185_129_/_0.05)] flex justify-between items-center" target="_blank">
