...
export async function DELETE(
  ...
  try {
    ...
    // deletion payloads BEFORE the delete commits; the Photo→Gallery
    // cascade is about to remove the rows.
    ...
    const usedByClient = await computeUsedStorageDeltaForDeletion({ galleryId: id });
